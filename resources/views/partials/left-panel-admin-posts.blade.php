<aside class="fixed top-20 left-5 w-[15%] bg-[color:#4E0F35] p-6 rounded-lg shadow-lg">
    ...
    <div class="relative mt-8">
        ...
        <ul class="space-y-2">
            <li><a href="#questions" class="pl-4 text-[color:#C18A8A] hover:underline">Questions</a></li>
            <li><a href="#answers" class="pl-4 text-[color:#C18A8A] hover:underline">Answers</a></li>
            <li><a href="#comments" class="pl-4 text-[color:#C18A8A] hover:underline">Comments</a></li>
        </ul>
    </div>
</aside>
