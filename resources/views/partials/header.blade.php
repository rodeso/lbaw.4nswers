                                    ...
                                    <li class="py-2 bg-[color:#C18A8A] px-4 rounded mb-3">
                                        ...
                                        @if ((!$notification->reason) && (!$notification->report))
                                            ...
                                            @if ($notification->question_id)
                                                ...
                                                <a class="font-bold text-[color:#4B1414] break-words" href="{{ route('question.show', ['id' => $notification->question_id]) }}" >Check it out!</a>
                                            @elseif ($notification->answer_question_id)
                                                <div class="text-sm text-black mb-3 break-words">
                                                    On the answer: "{{ $notification->post_body }}"
                                                </div>
                                                <a class="font-bold text-[color:#4B1414] break-words" href="{{ route('question.show', ['id' => $notification->answer_question_id]) }}" >Check it out!</a>
                                            @elseif ($notification->comment_question_id)
                                                <div class="text-sm text-black mb-3 break-words">
                                                    On the comment: "{{ $notification->post_body }}"
                                                </div>
                                                <a class="font-bold text-[color:#4B1414] break-words" href="{{ route('question.show', ['id' => $notification->comment_question_id]) }}" >Check it out!</a>
                                            @endif
