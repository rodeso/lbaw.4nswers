    ...
    <div class="flex flex-col min-h-screen">
        ...
        <header class="fixed top-0 left-0 w-full bg-gray-900 text-white px-8 py-2 flex justify-between items-center z-10">
            ...
            <div class="bg-gray-800 text-white py-2 px-4 overflow-x-auto whitespace-nowrap scroll-banner">
                <marquee>⚡ Urgent: Question about "X" is about to expire. View Hall of Fame 🎉 Join the Conversation Today!</marquee>
            </div>
            <!-- Right Side Buttons -->
            <div class="flex items-center space-x-2 right-"> 
                ...
                <button class="bg-gray-800 p-2 rounded-full squircle">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5-9 5-9 5-9 5z" />
                    </svg>
                </button>
            </div>
